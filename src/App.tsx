...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-[#1a1a1a] font-sans selection:bg-primary selection:text-white overflow-x-hidden">
      {/* Navigation */}
      <nav className={`fixed w-full z-50 transition-all duration-300 border-b-4 border-black ${isScrolled ? 'bg-white py-4 shadow-[0_4px_0_0_rgba(0,0,0,1)]' : 'bg-white py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8 items-center text-xs font-bold uppercase tracking-widest">
            ...
            <button onClick={() => scrollTo('menu')} className="hover:text-primary transition-colors">Menu Highlights</button>
            <button onClick={() => scrollTo('contact')} className="hover:text-primary transition-colors">Location</button>
            <a href="https://wa.me/351927337827" className="bg-primary text-white px-6 py-2 font-bold uppercase tracking-widest border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all">
              Book Now
            </a>
          </div>
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          ...
          >
            <div className="flex flex-col gap-6 font-display text-4xl uppercase tracking-wider">
              ...
              <a href="https://wa.me/351927337827" className="mt-8 bg-primary text-white text-center px-6 py-4 font-sans font-bold text-xl uppercase tracking-widest border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
                Book Now
              </a>
            </div>
          </motion.div>
      ...
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 px-6 bg-primary text-white border-b-4 border-black overflow-hidden z-10">
        ...
        <div className="max-w-7xl mx-auto flex flex-col items-center text-center relative z-10">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl lg:text-9xl font-display uppercase tracking-wider leading-[0.9] mb-6 max-w-4xl"
          >
      ...
      <section id="about" className="py-24 bg-[#F8F8F8] px-6 border-b-4 border-black">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-4xl md:text-6xl font-display uppercase tracking-wider mb-6 text-black leading-[1.1]">The perfect spot for your evenings.</h2>
          ...
          <div className="grid grid-cols-2 gap-6">
            <div className="bg-white aspect-[3/4] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden pt-8 rounded-none">
               <img src="/seafood.jpg" alt="Seafood and Tapas" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1541592106381-b31e9677c0e5?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }} />
            </div>
            <div className="bg-white aspect-[3/4] border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] overflow-hidden mt-12 rounded-none">
               <img src="/bar.jpg" alt="JAM Club Bar" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.src = "https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="menu" className="py-24 px-6 bg-white border-b-4 border-black">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
            <div>
              <h2 className="text-4xl md:text-6xl font-display uppercase tracking-wider mb-4 text-black">Menu Highlights</h2>
            ...
            <a href="#contact" className="text-primary font-bold uppercase tracking-widest flex items-center gap-2 hover:translate-x-1 transition-all shrink-0">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            {/* Column 1 */}
            <div>
              <div className="font-display text-2xl uppercase tracking-wider text-black mb-8 border-b-4 border-black pb-4">Tapas & Nibbles</div>
            ...
            {/* Column 2 */}
            <div>
              <div className="font-display text-2xl uppercase tracking-wider text-black mb-8 border-b-4 border-black pb-4">Mains & Burgers</div>
              <div className="flex flex-col gap-8">
            ...
            {/* Column 3 */}
            <div>
              <div className="font-display text-2xl uppercase tracking-wider text-black mb-8 border-b-4 border-black pb-4">Signature Cocktails</div>
              <div className="flex flex-col gap-8">
      ...
      <section className="py-12 bg-[#F8F8F8] px-6 border-b-4 border-black">
        <div className="max-w-7xl mx-auto flex gap-6 overflow-x-auto pb-6 snap-x menu-scroll">
          <div className="shrink-0 w-80 h-96 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] snap-center overflow-hidden">
            <img src="/bar.jpg" alt="Bar Interior" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
          </div>
          <div className="shrink-0 w-80 h-96 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] snap-center overflow-hidden">
            <img src="/seafood.jpg" alt="Seafood Platter" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
          </div>
          <div className="shrink-0 w-80 h-96 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] snap-center overflow-hidden">
            <img src="/shots.jpg" alt="Signature Shots" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
          </div>
          <div className="shrink-0 w-80 h-96 bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] snap-center overflow-hidden">
            <img src="/pub.jpg" alt="Pub Atmosphere" className="w-full h-full object-cover" onError={(e) => { e.currentTarget.style.display = 'none' }} />
          </div>
        </div>
      </section>
      ...
      <section id="contact" className="py-24 bg-black text-white px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-16">
          <div className="flex-1">
            <h2 className="text-4xl md:text-6xl font-display uppercase tracking-wider mb-6 text-primary leading-[1.1]">Come pull up a chair.</h2>
            ...
            <div className="flex flex-col gap-6">
              <ContactRow icon={<MapPin className="text-primary" />} text="Tv. dos Pescadores 27, 1200-328 Lisboa" />
              <ContactRow icon={<Clock className="text-primary" />} text="Open Every Day • 5:00 PM – 2:00 AM" />
              <ContactRow icon={<Phone className="text-primary" />} text={<a href="tel:927337827" className="hover:text-primary transition-colors">927 337 827</a>} />
              <ContactRow icon={<MessageCircle className="text-primary" />} text={<a href="https://wa.me/351927337827" className="hover:text-primary transition-colors">+351 927 337 827</a>} />
            </div>

            <div className="mt-12 flex flex-wrap gap-4">
              <a 
                href="https://www.google.pt/maps/place/Jam+Club/@38.7126972,-9.1487973,17z/data=!4m15!1m8!3m7!1s0xd19348002b7e7cd:0x77a77cebd3cc4e65!2sJam+Club!8m2!3d38.7126972!4d-9.1462224!10e2!16s%2Fg%2F11gfnd6snm!3m5!1s0xd19348002b7e7cd:0x77a77cebd3cc4e65!8m2!3d38.7126972!4d-9.1462224!16s%2Fg%2F11gfnd6snm?entry=ttu"
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-white text-black px-8 py-4 font-bold uppercase tracking-widest border-2 border-white shadow-[4px_4px_0px_0px_rgba(255,99,33,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all flex items-center justify-center"
              >
                Get Directions
              </a>
              <a 
                href="https://wa.me/351927337827"
                target="_blank" 
                rel="noopener noreferrer" 
                className="bg-primary text-white px-8 py-4 font-bold uppercase tracking-widest border-2 border-white shadow-[4px_4px_0px_0px_rgba(255,255,255,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all flex items-center justify-center"
              >
                WhatsApp Us
              </a>
            </div>
          ...
          <div className="flex-1 min-h-[400px] bg-neutral-800 border-4 border-white shadow-[8px_8px_0px_0px_rgba(255,99,33,1)] overflow-hidden relative">
            <iframe 
               src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3113.111867905872!2d-9.148797323869911!3d38.712697171761!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd19348002b7e7cd%3A0x77a77cebd3cc4e65!2sJam%20Club!5e0!3m2!1sen!2spt!4v1703000000000!5m2!1sen!2spt" 
      ...
      <footer className="bg-white border-t-4 border-black py-8 px-6 text-xs font-bold uppercase tracking-widest text-[#1a1a1a]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="text-2xl font-display uppercase tracking-wider text-black">
            JAM CLUB
          </div>
